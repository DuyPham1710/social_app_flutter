...
class _StoryRemoteDataSource implements StoryRemoteDataSource {
  ...
  Future<GroupedStoryListModel> getHomeStories(int page, int limit) async {
    ...
    final _options = _setStreamType<GroupedStoryListModel>(
    ...
    late GroupedStoryListModel _value;
    try {
  ...
  @override
  Future<GroupedStoryListModel> getMyActiveStories(int page, int limit) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page, r'limit': limit};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<void> updateStoryPrivacy(
    String storyId,
    Map<String, dynamic> updatePrivacyDto,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updatePrivacyDto);
    final _options = _setStreamType<void>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/story/privacy/${storyId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ReactStoryModel?> createOrUpdateReactStory(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<ReactStoryModel>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late ReactStoryModel? _value;
    try {
      _value = _result.data == null
          ? null
          : ReactStoryModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<ReactStoryModel>> getStoryReacts(String storyId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ReactStoryModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/react-story/${storyId}',
    ...
    late List<ReactStoryModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ReactStoryModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<Map<String, dynamic>?> checkUserReactStory(String storyId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Map<String, dynamic>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/react-story/user/current/${storyId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ReactStoryModel> updateReactStory(
    ...
    late ReactStoryModel _value;
    try {
      _value = ReactStoryModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> deleteReactStory(String storyId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
