...
class ReportUserBottomSheet extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    if (currentUserId != null && reportedUserId == currentUserId) {
      showErrorSnackBar(context, context.l10n.profileReportUserSelfNotAllowed);
      return;
    }
            ...
            child: ConstrainedBox(
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: ReportUserBottomSheet(reportedUserId: reportedUserId),
                ),
              ),
            ),
          );
...
class _ReportUserBottomSheetState extends State<ReportUserBottomSheet> {
  ...
  List<String> _quickReasons(AppLocalizations l10n) => [
    l10n.profileReportReasonFakeAccount,
  ...
  Future<void> _handleSubmit() async {
    ...
    final usecase = di.s1<ReportUserUseCase>();
    ...
    if (result is DataStateSuccess) {
      if (mounted) {
        ...
        showSuccessSnackBar(context, l10n.profileReportUserSuccess);
      }
    } else {
      if (mounted) {
        showErrorSnackBar(context, l10n.profileReportUserFailed);
      }
    }
  }
