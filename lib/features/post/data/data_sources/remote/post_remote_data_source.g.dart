...
class _PostRemoteDataSource implements PostRemoteDataSource {
  ...
  @override
  Future<PostListModel> getUserPosts(String userId, int page, int limit) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page, r'limit': limit};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<CaptionTranslationEligibilityModel> getCaptionTranslationEligibility(
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'targetLang': targetLang};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CaptionTranslationEligibilityModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/post/${postId}/caption-translation-eligibility',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CaptionTranslationEligibilityModel _value;
    try {
      _value = CaptionTranslationEligibilityModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PostTranslationModel> translateCaption(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PostTranslationModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PostTranslationModel _value;
    try {
      _value = PostTranslationModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
