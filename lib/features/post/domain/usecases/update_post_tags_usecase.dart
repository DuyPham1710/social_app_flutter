...
class UpdatePostTagsUsecase implements UseCase<DataState<void>, UpdatePostTagsParams> {
...
class UpdatePostTagsParams {
  ...
  const UpdatePostTagsParams({required this.postId, required this.taggedUserIds});
}
