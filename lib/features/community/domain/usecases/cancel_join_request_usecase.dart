...
class CancelJoinRequestUseCase extends UseCase<DataState<void>, String> {
  final CommunityRepository _communityRepository;

  CancelJoinRequestUseCase(this._communityRepository);
  ...
  Future<DataState<void>> call({String? params}) async {
    ...
    return await _communityRepository.cancelJoinRequest(params);
  }
}
