...
class EditCommunityPage extends StatefulWidget {
  ...
  EditCommunityPage({super.key, required this.initialCommunity});
                            ...
                            child: Container(
                              ...
                              child: _avatarPath != null
                                  ? ClipRRect(
                                      ...
                                      child: (kIsWeb || _avatarPath!.startsWith('http'))
                                          ? Image.network(
                                              _avatarPath!,
                                              fit: BoxFit.cover,
                                            )
                            ...
                            child: Container(
                              ...
                              child: _coverImagePath != null
                                  ? ClipRRect(
                                      ...
                                      child: (kIsWeb || _coverImagePath!.startsWith('http'))
                                          ? Image.network(
                                              _coverImagePath!,
                                              fit: BoxFit.cover,
                                            )
