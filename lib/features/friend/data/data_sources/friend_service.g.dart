...
class _FriendService implements FriendService {
  ...
  Future<FriendRequestModel> sendFriendRequest(
    ...
    final _options = _setStreamType<FriendRequestModel>(
  ...
  Future<Map<String, dynamic>> rejectFriendRequest(String requestId) async {
    ...
    final _options = _setStreamType<Map<String, dynamic>>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/friends/${requestId}/rejected-request',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<List<FriendModel>> searchFriends(Map<String, dynamic> queries) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<List<FriendModel>> getFriendsbyUserId(String targetUserId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    try {
      _value = _result.data!
          .map(
            (dynamic item) =>
                FriendModel.fromJson(item as Map<String, dynamic>),
          )
          .toList();
    } catch (e, s) {
      rethrow;
  ...
  @override
  Future<dynamic> getReceivedRequests(Map<String, dynamic> queries) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(queries);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<dynamic> getSentRequests(Map<String, dynamic> queries) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(queries);
    final _headers = <String, dynamic>{};
  ...
  Future<RelationshipStatusModel> getRelationshipStatus(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RelationshipStatusModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RelationshipStatusModel _value;
    try {
