...
part 'friend_for_user_event.dart';
part 'friend_for_user_state.dart';

class FriendForUserBloc extends Bloc<FriendForUserEvent, FriendForUserState> {
  ...
  Future<void> _onLoadFriends(
    LoadFriends event,
    Emitter<FriendForUserState> emit,
  ) async {
    emit(FriendLoading());
