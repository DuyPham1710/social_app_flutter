...
class _$ResetPasswordRequestImpl implements _ResetPasswordRequest {
  ...
  @override
  String toString() {
    return 'ResetPasswordRequest(email: $email, otp: $otp, newPassword: $newPassword, confirmNewPassword: $confirmNewPassword)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, otp, newPassword, confirmNewPassword);
